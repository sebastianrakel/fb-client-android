...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHostname = getIntent().getExtras().getString("hostname");

        Button mGetApikeyButton = (Button) findViewById(R.id.get_apikey_button);
    ...
    public class UserLoginTask extends AsyncTask<Void, String, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                String apikey = filebinClient.generateApikey(mUsername, mPassword);
                return apikey;
        ...
        protected void onPostExecute(final String apikey) {
            ...
            if (apikey != null && apikey.length() > 0) {
                getIntent().putExtra("apikey", apikey);
